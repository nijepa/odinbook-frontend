<template>
  <footer>
    <p>
      Odin-book by <a href="mailto:nijepa@hotmail.com"> Nikola Pavicevic </a> @
      2020
    </p>
    <p>
      ...
      , NodeJS path. The source code can be viewed on
      <a href="https://github.com/nijepa/odinbook-frontend" target="blank">
        GitHub
      </a>
      .
    </p>
